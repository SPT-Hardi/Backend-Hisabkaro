...
// Code is generated on: 13-04-2022 14:27:41
//
...
namespace HisabKaroDBContext
{
    ...
    public partial class HisabKaroDBDataContext : Devart.Data.Linq.DataContext
    {
        public static CompiledQueryCache compiledQueryCache = CompiledQueryCache.RegisterDataContext(typeof(HisabKaroDBDataContext));
        ...
        public HisabKaroDBDataContext(MappingSource mappingSource) :
        base(@"Data Source=20.204.136.73;Initial Catalog=HisabKaroDB;Integrated Security=False;Persist Security Info=True;User ID=HisabKaroDB;Password=Otobit@2022@@#", mappingSource)
        {
            OnCreated();
        }

        public HisabKaroDBDataContext(string connection) :
            base(connection, mappingSource)
        {
          OnCreated();
        }

        public HisabKaroDBDataContext(System.Data.IDbConnection connection) :
            base(connection, mappingSource)
        {
          OnCreated();
        }

        public HisabKaroDBDataContext(string connection, MappingSource mappingSource) :
            base(connection, mappingSource)
        {
          OnCreated();
        }

        public HisabKaroDBDataContext(System.Data.IDbConnection connection, MappingSource mappingSource) :
            base(connection, mappingSource)
        {
          OnCreated();
        }
...
namespace HisabKaroDBContext
{
    ...
    public partial class DevOrganisation : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// There are no comments for BussinessTypeId in the schema.
        /// </summary>
        [Column(Storage = "_BussinessTypeId", DbType = "INT", UpdateCheck = UpdateCheck.Never)]
        public int? BussinessTypeId
        {
            ...
            set
            {
                if (this._BussinessTypeId != value)
                {
                    ...
                    this.SendPropertyChanging("BussinessTypeId");
    ...
    public partial class DevOrganisationsStaff : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_Salary", DbType = "FLOAT", UpdateCheck = UpdateCheck.Never)]
        ...
        /// There are no comments for SubUser in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SubUser_DevOrganisationsStaff", Storage="_SubUser", ThisKey="UId", OtherKey="UId", IsForeignKey=true)]
        public SubUser SubUser
        {
            get
            {
    ...
    public partial class EmpResumeEducation : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<SubLookup> _SubLookup;
        ...
        partial void OnEducationSteamIdChanging(int? value);
        partial void OnEducationSteamIdChanged();
        ...
        public EmpResumeEducation()
        {
            ...
            this._SubLookup  = default(EntityRef<SubLookup>);
            this._SubUser  = default(EntityRef<SubUser>);
            OnCreated();
        }
        ...
        /// <summary>
        /// There are no comments for EducationSteamId in the schema.
        /// </summary>
        [Column(Storage = "_EducationSteamId", DbType = "INT", UpdateCheck = UpdateCheck.Never)]
        public int? EducationSteamId
        {
            get
            {
                return this._EducationSteamId;
            }
            set
            {
                if (this._EducationSteamId != value)
                {
                    if (this._SubLookup.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }

                    this.OnEducationSteamIdChanging(value);
                    this.SendPropertyChanging("EducationSteamId");
                    this._EducationSteamId = value;
                    this.SendPropertyChanged("EducationSteamId");
                    this.OnEducationSteamIdChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for SubLookup in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SubLookup_EmpResumeEducation", Storage="_SubLookup", ThisKey="EducationSteamId", OtherKey="LookupId", IsForeignKey=true)]
        public SubLookup SubLookup
        {
            get
            {
                return this._SubLookup.Entity;
            }
            set
            {
                SubLookup previousValue = this._SubLookup.Entity;
                if ((previousValue != value) || (this._SubLookup.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("SubLookup");
                    if (previousValue != null)
                    {
                        this._SubLookup.Entity = null;
                        previousValue.EmpResumeEducations.Remove(this);
                    }
                    this._SubLookup.Entity = value;
                    if (value != null)
                    {
                        this._EducationSteamId = value.LookupId;
                        value.EmpResumeEducations.Add(this);
                    }
                    else
                    {
                        this._EducationSteamId = default(int?);
                    }
                    this.SendPropertyChanged("SubLookup");
                }
            }
        }
    ...
    public partial class OrgStaffsAttendancesDaily : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for SubUser in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SubUser_OrgStaffsAttendancesDaily", Storage="_SubUser", ThisKey="UId", OtherKey="UId", IsForeignKey=true)]
        public SubUser SubUser
        {
            get
            {
    ...
    public partial class OrgStaffsLeaveApplication : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for SubUser in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SubUser_OrgStaffsLeaveApplication", Storage="_SubUser", ThisKey="UId", OtherKey="UId", IsForeignKey=true)]
        public SubUser SubUser
        {
            get
            {
        ...
        /// There are no comments for SubRole in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SubRole_OrgStaffsLeaveApplication", Storage="_SubRole", ThisKey="RId", OtherKey="RId", IsForeignKey=true)]
        public SubRole SubRole
        {
            get
            {
    ...
    public partial class SubLookup : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for EmpResumeEducations in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SubLookup_EmpResumeEducation", Storage="_EmpResumeEducations", ThisKey="LookupId", OtherKey="EducationSteamId", DeleteRule="NO ACTION")]
        public EntitySet<EmpResumeEducation> EmpResumeEducations
        {
            get
            {
        ...
        {
            this.SendPropertyChanging("EmpResumeEducations");
            entity.SubLookup = this;
        }
    
        private void detach_EmpResumeEducations(EmpResumeEducation entity)
        {
            this.SendPropertyChanging("EmpResumeEducations");
            entity.SubLookup = null;
        }
    }
    ...
    public partial class SubRole : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SubRole_OrgStaffsLeaveApplication", Storage="_OrgStaffsLeaveApplications", ThisKey="RId", OtherKey="RId", DeleteRule="NO ACTION")]
    ...
    public partial class SubUserOrganisation : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for OId in the schema.
        /// </summary>
        [Column(Storage = "_OId", CanBeNull = false, DbType = "INT NOT NULL", IsPrimaryKey = true)]
        public int OId
        {
            get
            {
    ...
    public partial class SubUser : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for DevOrganisationsStaffs in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SubUser_DevOrganisationsStaff", Storage="_DevOrganisationsStaffs", ThisKey="UId", OtherKey="UId", DeleteRule="NO ACTION")]
        public EntitySet<DevOrganisationsStaff> DevOrganisationsStaffs
        {
            get
            {
        ...
        /// There are no comments for OrgStaffsAttendancesDailies in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SubUser_OrgStaffsAttendancesDaily", Storage="_OrgStaffsAttendancesDailies", ThisKey="UId", OtherKey="UId", DeleteRule="NO ACTION")]
        public EntitySet<OrgStaffsAttendancesDaily> OrgStaffsAttendancesDailies
        {
            get
            {
        ...
        /// There are no comments for OrgStaffsLeaveApplications in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SubUser_OrgStaffsLeaveApplication", Storage="_OrgStaffsLeaveApplications", ThisKey="UId", OtherKey="UId", DeleteRule="NO ACTION")]
        public EntitySet<OrgStaffsLeaveApplication> OrgStaffsLeaveApplications
        {
            get
            {
    ...
    public partial class SubUsersDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnFileIdChanging(int? value);
        partial void OnFileIdChanged();
        partial void OnCompleteProfileChanging(int? value);
        partial void OnCompleteProfileChanged();
        #endregion
        ...
        /// <summary>
        /// There are no comments for CompleteProfile in the schema.
        /// </summary>
        [Column(Storage = "_CompleteProfile", DbType = "INT", UpdateCheck = UpdateCheck.Never)]
        public int? CompleteProfile
        {
            get
            {
                return this._CompleteProfile;
            }
            set
            {
                if (this._CompleteProfile != value)
                {
                    this.OnCompleteProfileChanging(value);
                    this.SendPropertyChanging("CompleteProfile");
                    this._CompleteProfile = value;
                    this.SendPropertyChanged("CompleteProfile");
                    this.OnCompleteProfileChanged();
                }
            }
        }
